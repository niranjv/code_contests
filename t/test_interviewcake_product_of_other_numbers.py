...
def test_empty_list():
    ...
    assert str(e.value) == "Need at least 2 numbers in the input list" 
...
def test_sample_list_with_zeros():
    # test sample input list in problem description
    nums = [1, 2, 0, 4]
    result = interviewcake_product_of_other_numbers.get_products_of_all_ints_except_at_index(nums)
    assert result == [0, 0, 8, 0]

def test_sample_list_1():
    # test sample input list in problem description
    nums = [1, 7, 3, 4]
    result = interviewcake_product_of_other_numbers.get_products_of_all_ints_except_at_index(nums)
    assert result == [84, 12, 28, 21]

def test_sample_list_2():
    # test sample input list in problem description
    nums = [1, 2, 6, 5, 9]
    result = interviewcake_product_of_other_numbers.get_products_of_all_ints_except_at_index(nums)
